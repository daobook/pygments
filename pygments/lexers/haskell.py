...
class HaskellLexer(RegexLexer):
    ...
    tokens = {
        ...
        'import': [
            ...
            (
                f'([{uni.Lu}][\\w.]*)(\\s+)(as)(\\s+)([{uni.Lu}][\\w.]*)',
                bygroups(Name.Namespace, Text, Keyword, Text, Name),
                '#pop',
            ),
            (
                f'([{uni.Lu}][\\w.]*)(\\s+)(hiding)(\\s+)(\\()',
                bygroups(Name.Namespace, Text, Keyword, Text, Punctuation),
                'funclist',
            ),
            (
                f'([{uni.Lu}][\\w.]*)(\\s+)(\\()',
        ...
        'module': [
            ...
            (f'[{uni.Lu}][\\w.]*', Name.Namespace, '#pop'),
        ],
        'funclist': [
            (r'\s+', Text),
            (f'[{uni.Lu}]\\w*', Keyword.Type),
...
class LiterateLexer(Lexer):
    ...
    def get_tokens_unprocessed(self, text):
        ...
        if style is None:
            style = 'latex' if text.lstrip()[:1] in '%\\' else 'bird'
...
class KokaLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            include('whitespace'),
            (f'::?{sboundary}', tokenType, 'type'),
            (
                r'(alias)(\s+)([a-z]\w*)?',
                bygroups(Keyword, Text, tokenTypeDef),
                'alias-type',
            ),
            (
                r'(struct)(\s+)([a-z]\w*)?',
        ...
        'type-content': [
            ...
            (f'[EPHVX]{boundary}', tokenType),
            (r'[a-z][0-9]*(?![\w/])', tokenType),
            (r'_\w*', tokenType.Variable),
            (
                r'((?:[a-z]\w*/)*)([A-Z]\w*)',
